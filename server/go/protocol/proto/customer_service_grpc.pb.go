...
func (c *customerServiceClient) ListPerson(ctx context.Context, in *RequestType, opts ...grpc.CallOption) (CustomerService_ListPersonClient, error) {
	stream, err := c.cc.NewStream(ctx, &CustomerService_ServiceDesc.Streams[0], "/protocol.CustomerService/ListPerson", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *customerServiceClient) AddPerson(ctx context.Context, in *Person, opts ...grpc.CallOption) (*ResponseType, error) {
	...
	err := c.cc.Invoke(ctx, "/protocol.CustomerService/AddPerson", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protocol.CustomerService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.CustomerService/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
